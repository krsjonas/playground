...
if number_of_numbers == 1:
    ...
    number_8 = int(input("Gib die achte Zahl ein: "))
    number_9 = int(input("Gib die neunte Zahl ein: "))
    number_10 = int(input("Gib die zehnte Zahl ein: "))
    print("Welchen Operator willst Du benutzen?")
    print("1: +")
    print("2: -")
    print("3: *")
    ...
    operator = int(input())
    if operator == 1:
        result = number_1 + number_2 + number_3 + number_4 + number_5 + number_6 + number_7 + number_8 + number_9 + number_10
    elif operator == 2:
        result = number_1 - number_2 - number_3 - number_4 - number_5 - number_6 - number_7 - number_8 - number_9 - number_10
    elif operator == 3:
        result = number_1 * number_2 * number_3 * number_4 * number_5 * number_6 * number_7 * number_8 * number_9 * number_10
